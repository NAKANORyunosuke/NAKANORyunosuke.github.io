...
(() => {
    ...
    function initMenuToggle() {
        ...
        document.addEventListener(LANGUAGE_EVENT, (event) => {
            ...
            button.setAttribute(
                "title",
                LANGUAGE_LABELS[lang] || LANGUAGE_LABELS.ja,
            );
        });
    }
    ...
    function updateButtonLabels(button, lang, state) {
        ...
        button.setAttribute(
            "aria-label",
            state === "copied" ? labels.copiedAria : labels.copyAria,
        );
        button.setAttribute(
            "title",
    ...
    function createButton(lang) {
        ...
        button.innerHTML =
            '<span class="label-copy lang-ja">\u30B3\u30D4\u30FC</span><span class="label-copy lang-en">Copy</span><span class="label-copied lang-ja">\u30B3\u30D4\u30FC\u6E08\u307F</span><span class="label-copied lang-en">Copied</span>';
    ...
    function initCodeCopy() {
        ...
        document.addEventListener(LANGUAGE_EVENT, (event) => {
            ...
            document.querySelectorAll(".code-copy").forEach((button) => {
                const state =
                    button.dataset.state === "copied" ? "copied" : "copy";
